## [Unreleased]
### Added
- MANTA-1176 Add unit tests for EstimateSVLoci modules
- MANTA-1097 Add handling MateCigar BAM tag in adapter-read check
- MANTA-1218 Add sanity check of specified target regions

### Changed
- MANTA-1039 Change candidateSV.vcf to include all candidates used to generate final calls
- MANTA-1245 Reformat change log to Markdown

### Fixed
- MANTA-1236 Fix a bug in contig output to cover all SV types
