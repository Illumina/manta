...
% The merge procedure is described without a layer implementation detail: locus.
% The merge abortion is actually applied to a whole locus instead of just the candidate merge node.
% The complexity check has been turned off for loci containing more than two nodes.
