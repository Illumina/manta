...
TestSVLocusSetOutEdges(
    const SVLocusSet& set1,
    unsigned locusIndex,
    const std::vector<unsigned>& expectedEdgeOutCount)
{
...
BOOST_AUTO_TEST_CASE( test_SVLocusSet_DumpLoci )
{
    ...
    BOOST_REQUIRE(FindStringInFile(test3, "NodeIndex: 0 LocusNode: GenomeInterval: 1:[10,20) n_edges: 1 out_count: 2 in_count: 0 evidence: [10,20)"));
    BOOST_REQUIRE(FindStringInFile(test3, "NodeIndex: 1 LocusNode: GenomeInterval: 2:[30,40) n_edges: 1 out_count: 0 in_count: 2 evidence: [30,40)"));
    ...
    BOOST_REQUIRE(!FindStringInFile(test4, "NodeIndex: 0 LocusNode: GenomeInterval: 1:[10,20) n_edges: 1 out_count: 2 in_count: 0 evidence: [10,20)"));
    BOOST_REQUIRE(FindStringInFile(test4, "LocusNode: GenomeInterval: 1:[10,20) n_edges: 1 out_count: 2 evidence: [10,20)"));
